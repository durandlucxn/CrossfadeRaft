 ...
 * This file demonstrates how to integrate Crossfaderaft with a web frontend
 */

// For React/Vue/Angular applications
export class CrossfaderaftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CrossfaderaftClient(provider, contractAddress);
