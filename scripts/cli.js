...
const contractABI = require("../artifacts/contracts/Crossfaderaft.sol/Crossfaderaft.json").abi;

program
    .name("crossfaderaft-cli")
    .description("CLI tool for Crossfaderaft smart contract")
    .version("1.0.0");
